         ...
         <i> * - Mandatory fields</i> <br/>
          ...
          <script type="text/javascript">
              function clearResultArea()
              {
                  ...
                  //document.getElementById("tabarea").style="visibility: hidden;";
                  
                 // console.log(predictions.innerHtml);
...
<div id="tabarea">  
  <form id="predictions">
       <?php
        ...
        $g_url=$g_url.urlencode('&key=AIzaSyASn85RPG7ICkSK04JwNzA191aTc_YDlZU');
                        //echo $url."<br>";
       // echo $g_url;
      ...
      if($status!='OK'){
        ...
        if($status=='OK'):
                        ...
                        // echo 'latitude,lng: '.$lat.' ,'.$lng;
                 //JSON       
                        $fore_url='https://api.forecast.io/forecast/';
                        $apikey='d2dc20fc5ee16262f0908f7348cd5463';
